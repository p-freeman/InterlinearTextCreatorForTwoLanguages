...
class InterlinearApp:
    ...
    def __init__(self, root):
        ...
        self.label_swissgerman = tk.Label(self.frame, text="Swiss-German Words:")
        ...
        self.entry_swissgerman.bind("<Button-1>", self.scroll_english_to_same_line)
        
        self.label_english = tk.Label(self.frame, text="English Words:")
    ...
    def create_interlinear(self):
        if not (self.entry_title.get() or self.entry_filename.get() or self.entry_swissgerman.get("1.0", tk.END).strip() or self.entry_english.get("1.0", tk.END).strip() or self.entry_vertical_distance.get() or self.entry_font_size.get()):
            return  
        ...
        for swissgerman_line, english_line in zip(swissgerman_lines, english_lines):
        ...
        print("Swiss-German text saved to:", swissgerman_text_path)

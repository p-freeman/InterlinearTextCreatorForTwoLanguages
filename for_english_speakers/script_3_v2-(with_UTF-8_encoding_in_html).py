...
class InterlinearApp:
    ...
    def __init__(self, root):
        ...
        # Create line number display for German and English text fields
        self.german_line_numbers = LineNumbers(self.frame, width=4, bg="#f0f0f0", bd=0, wrap="none")
        self.german_line_numbers.grid(row=3, column=2, sticky="nsew")
        
        self.english_line_numbers = LineNumbers(self.frame, width=4, bg="#f0f0f0", bd=0, wrap="none")
        self.english_line_numbers.grid(row=3, column=3, sticky="nsew")
        
        self.label_german = tk.Label(self.frame, text="German Words:")
        ...
        self.entry_german.bind("<Button-1>", self.scroll_english_to_same_line)
    ...
    def create_interlinear(self):
        ...
        if not (self.entry_title.get() or self.entry_filename.get() or self.entry_german.get("1.0", tk.END).strip() or self.entry_english.get("1.0", tk.END).strip() or self.entry_vertical_distance.get() or self.entry_font_size.get()):
        ...
        # Save German and English text to text files with Windows-compatible line breaks
        ...
        # Read German and English text files
        ...
        # Iterate through German and English lines to create interlinear pairs
    ...
    def scroll_english_to_same_line(self, event):
        """
        Scroll the English text field to the same line as the clicked line in the German text field.
        """

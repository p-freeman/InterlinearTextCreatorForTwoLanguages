...
class InterlinearApp:
    ...
    def __init__(self, root):
        ...
        self.label_video_link = tk.Label(self.frame, text="Link zum Video (URL) *optional:")
        ...
        self.audio_checkbox = tk.Checkbutton(self.frame, text="Audio-Datei verfügbar *optional", variable=self.audio_checkbox_var)
    ...
    def create_interlinear(self):
        ...
        for french_line, german_line in zip(french_lines, german_lines):
            ...
            interlinear_html += f"<div class='french_word'><b>{french_line.strip()}</b></div>\n"  
